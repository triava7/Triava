...
import { ArrowRight, Zap, Euro, CheckCircle, Users } from 'lucide-react';
...
export const Home = () => {
  ...
  return (
    <main>
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50 dark:from-slate-950 dark:via-blue-950 dark:to-slate-900">
        <HeroAnimation />
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <h1 className="text-fluid-4xl font-bold text-slate-900 dark:text-white leading-tight">
              {t('hero_title')}
            </h1>
            <p className="text-fluid-xl text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
              {t('hero_description')}
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link to="/services">
                <Button
                  size="lg"
                  variant="outline"
                  className="rounded-lg border-2 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all duration-300"
                >
                  {t('cta_services')}
                </Button>
              </Link>
